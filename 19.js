...
// 		var totalNum = a.females + a.males + b.females + b.males;
// 		console.log('totalNum of M&F: ' + totalNum);

// 		var result = Math.round((a.females + b.females) / totalNum * 100000) / 1000;

// 		console.log(result);
// 		document.getElementById('femaleRat').innerHTML = result;
...
//=========find total population of U.S. for all ages

function totalPop(data){
	return data.reduce(function(a,b){
		return a + b.females + b.males;
	},0)
}
//console.log(totalPop(popdata2)); // --> 6790000

document.getElementById('totalP').innerHTML = totalPop(popdata2);


//=========ratio of females in total population

function femalePer(data){
...
//console.log(femalePer(popdata2));

document.getElementById('femaleP').innerHTML = femalePer(popdata2) + '%';


//=========ratio of males in total population

function malePer(data){
	var result = data.reduce(function(a,b){
		return (a + b.males); 
	},0)/totalPop(data);
	return Math.round(result * 100000) / 1000;
